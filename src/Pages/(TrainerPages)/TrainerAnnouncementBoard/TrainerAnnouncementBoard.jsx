...
// Announcement form for Add/Edit using TipTap
function AnnouncementForm({ initialData = {}, onCancel, onSave }) {
  ...
  return (
    <div className="bg-white border-4 border-gray-600 rounded-2xl shadow-md p-5 text-black">
      <form onSubmit={handleSubmit}>
        <div className="flex items-center gap-4 border border-gray-400 rounded-t-lg px-4 py-3 shadow-sm bg-white mb-4">
