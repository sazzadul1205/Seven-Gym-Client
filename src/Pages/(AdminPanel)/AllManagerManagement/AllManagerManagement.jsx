...
import AllUserManagementDropdown from "../AllUserManagement/AllUserManagementDropdown/AllUserManagementDropdown";

const AllManagerManagement = ({ AllUsersData, Refetch }) => {
  // State: Search input for filtering by name
  const [searchTerm, setSearchTerm] = useState("");

  // State: Filter by selected Managership tier
  ...
  // Extract unique Managership tiers from Manager users
  const uniqueTiers = [
    "All",
    ...new Set(
      AllUsersData.filter((u) => u.role === "Manager").map((u) => u.tier)
    ),
  ];

  // Apply all filters: role = Manager, name search, tier, gender
  const filteredUsers = AllUsersData.filter((user) => user.role === "Manager")
    .filter((user) =>
...
// Prop Validation
AllManagerManagement.propTypes = {
...
export default AllManagerManagement;
