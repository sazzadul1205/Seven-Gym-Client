...
const HomePageAdminFeaturesAddModal = ({ Refetch }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axiosPublic.post(`/Gym_Features`, payload);
      ...
      // Close modal
      document.getElementById("Add_Features_Modal").close();

      Swal.fire({
        icon: "success",
        title: "Features Added Successfully",
        text: "Your new Features has been successfully Saved.",
  ...
  return (
    <div className="modal-box max-w-xl w-full p-0 bg-gradient-to-b from-white to-gray-100 text-black">
      ...
      <div className="flex justify-between items-center border-b-2 border-gray-200 px-5 py-4">
        <h3 className="font-bold text-lg">Add New Features</h3>
        <ImCross
          className="text-xl hover:text-[#F72C5B] cursor-pointer"
          onClick={() => document.getElementById("Add_Features_Modal").close()}
        />
      </div>
...
// Prop Validation
HomePageAdminFeaturesAddModal.propTypes = {
  Refetch: PropTypes.func.isRequired,
};

export default HomePageAdminFeaturesAddModal;
