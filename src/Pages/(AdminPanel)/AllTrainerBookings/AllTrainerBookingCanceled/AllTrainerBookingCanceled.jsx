...
const AllTrainerBookingCanceled = ({ AllTrainerBookingCancelledData }) => {
  ...
  const sessionOptions = useMemo(() => {
    const uniqueSessions = new Set(
      AllTrainerBookingCancelledData.map((b) => b.sessions.length)
    );
  ...
  const durationOptions = useMemo(() => {
    const uniqueDurations = new Set(
      AllTrainerBookingCancelledData.map((b) => b.durationWeeks)
    );
  ...
  const monthYearOptions = useMemo(() => {
    ...
    AllTrainerBookingCancelledData.forEach(({ bookedAt }) => {
      if (!bookedAt) return;
  ...
  const filteredData = useMemo(() => {
    return AllTrainerBookingCancelledData.filter((booking) => {
...
AllTrainerBookingCanceled.propTypes = {
  AllTrainerBookingCancelledData: PropTypes.arrayOf(
    PropTypes.shape({
...
export default AllTrainerBookingCanceled;
