...
const OurMissionHeroSectionEditModal = ({ Refetch, OurMissionsData }) => {
  ...
  // Set Image Preview
  useEffect(() => {
    if (OurMissionsData?.hero) {
      setValue("title", OurMissionsData.hero.title || "");
      setValue("subTitle", OurMissionsData.hero.subTitle || "");
      setPreview(OurMissionsData.hero.img || "");
    }
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      document.getElementById("Our_Mission_Hero_Section_Edit_Modal").close();
...
// Prop Validation
OurMissionHeroSectionEditModal.propTypes = {
