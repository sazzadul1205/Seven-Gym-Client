...
const AboutUsFeaturesCardAddModal = ({ Refetch }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axiosPublic.patch(`/AboutUs/AddMissionVisionValue`, payload);
      ...
      // Close modal
      document.getElementById("About_Us_Information_Card_Add_Modal").close();
  ...
  return (
    <div className="modal-box max-w-2xl w-full p-0 bg-gradient-to-b from-white to-gray-100 text-black">
      ...
      <div className="flex justify-between items-center border-b-2 border-gray-500 px-5 py-4">
        <h3 className="font-bold text-lg">Add New Information</h3>
        <ImCross
...
// Prop Validation
AboutUsFeaturesCardAddModal.propTypes = {
  Refetch: PropTypes.func.isRequired,
};

export default AboutUsFeaturesCardAddModal;
