...
const AboutUsBackgroundEditModal = ({ Refetch, AboutUsData }) => {
  ...
  // Set Image Preview
  useEffect(() => {
    if (AboutUsData?.background) {
      setPreview(AboutUsData.background);
    }
  }, [AboutUsData]);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Close modal
      document.getElementById("About_Us_Background_Edit_Modal").close();
...
// Prop Validation
AboutUsBackgroundEditModal.propTypes = {
...
export default AboutUsBackgroundEditModal;
