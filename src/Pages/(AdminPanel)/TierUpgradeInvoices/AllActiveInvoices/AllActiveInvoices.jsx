...
const AllActiveInvoices = ({ ActiveTierPaymentData }) => {
  ...
  const totalPages = Math.ceil(
    (ActiveTierPaymentData?.length || 0) / itemsPerPage
  );

  // Slice the data array to only show items for the current page
  const currentData = ActiveTierPaymentData?.slice(
  ...
  return (
    <div>
      ...
      {Array.isArray(ActiveTierPaymentData) &&
      ActiveTierPaymentData.length > 0 ? (
                ...
                <tr key={item._id} className="hover:bg-gray-50">
                  ...
                  <td className="border px-4 py-2">
                    ...
                    <Tooltip
                      ...
                      content="View Active Tier Upgrade Payment Invoice"
                    />
                  </td>
                </tr>
              ))}
