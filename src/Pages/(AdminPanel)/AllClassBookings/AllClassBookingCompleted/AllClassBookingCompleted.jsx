...
const AllClassBookingCompleted = ({ ClassBookingCompletedData }) => {
  // State Management
...
// Prop Validation
AllClassBookingCompleted.propTypes = {
...
export default AllClassBookingCompleted;
