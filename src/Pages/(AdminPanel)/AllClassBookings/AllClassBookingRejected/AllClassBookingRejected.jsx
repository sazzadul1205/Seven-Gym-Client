...
const AllClassBookingRejected = ({ ClassBookingRejectedData }) => {
...
// Prop Validation
AllClassBookingRejected.propTypes = {
  ClassBookingRejectedData: PropTypes.arrayOf(
    PropTypes.shape({
      ...
      rejectedAt: PropTypes.oneOfType([
        PropTypes.string,
        PropTypes.instanceOf(Date),
      ]),
      droppedAt: PropTypes.oneOfType([
        PropTypes.string,
        PropTypes.instanceOf(Date),
      ]),
...
export default AllClassBookingRejected;
