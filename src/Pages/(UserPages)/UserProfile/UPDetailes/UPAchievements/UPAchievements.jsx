...
const UPAchievements = ({ usersData, refetch }) => {
  ...
  return (
    <div className="bg-linear-to-bl from-gray-white to-gray-200 p-5 shadow-xl rounded-xl">
      {/* Header Section */}
        ...
        {favoriteAwards.length > 0 ? (
          favoriteAwards.map((award, index) => (
            <div
              ...
              className="flex items-center bg-gradient-to-bl hover:bg-gradient-to-tr from-white to-gray-200 rounded-4xl border border-gray-500/20 p-1 gap-2"
            >
              {/* Award Icon */}
              <img
                src={award.awardIcon}
