...
const UserTrainerBookingAcceptModal = ({ selectedBooking }) => {
            ...
            <div className="space-y-2 text-sm sm:text-base">
              ...
              <div className="flex items-center">
                ...
                <input
                  type="text"
                  placeholder="*******"
                  className="input input-bordered rounded-lg bg-white border-gray-600 w-1/2"
                />
              </div>
            </div>
          </div>
...
export default UserTrainerBookingAcceptModal;
