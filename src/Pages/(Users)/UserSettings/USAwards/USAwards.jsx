    ...
    <div className="w-full bg-gray-200 min-h-screen">
      ...
      <div className="p-5">
        ...
        <div className="flex justify-between items-center mb-5">
          <div>
            <button className="flex gap-3 items-center bg-gradient-to-br hover:bg-gradient-to-tr from-green-500 to-green-300 text-gray-100 hover:text-gray-500 font-semibold px-16 py-3 rounded-lg">
              + Add Awards <FaTrophy />
            </button>
          </div>
