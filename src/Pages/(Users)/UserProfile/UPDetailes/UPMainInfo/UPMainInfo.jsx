...
const UPMainInfo = ({ usersData }) => {
  return (
    <div className="space-y-4 bg-white p-5 shadow-xl rounded-xl transition-transform duration-300 hover:scale-105 hover:delay-150">
      ...
      {/* Info Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 pt-5 border-t">
        {/* Phone */}
